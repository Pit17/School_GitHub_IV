...
namespace ConsoleAppBanca
{
    internal class Program
    {
        ...
        static void Main(string[] args)//main per verificare tutte le funzioni
        {
            ...
            Console.WriteLine("\nRimozione del cliente Mario Rossi dalla banca.");//rimozione di un cliente
            banca.RemoveCliente("MRORSS80A01H501Z");

            
            var clienteRimosso = banca.SearchCliente("MRORSS80A01H501Z");//verifico se il cliente è stato rimosso
