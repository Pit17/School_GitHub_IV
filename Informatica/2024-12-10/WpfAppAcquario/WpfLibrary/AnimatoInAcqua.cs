...
namespace WpfLibrary
{
    public class AnimatoInAcqua : Inanimato
    {
        ...
        public Image AggiungiConAnimazione(string nome_foto, int altezzaTop,double canvasWidth)
        {
            ...
            Start2(immagine,canvasWidth);

            return immagine;
        }
        public void Start2(Image immagine , double canvasWidth)
        {
        ...
        private void SpecchiaImmagine2(Image immagine)
        {
